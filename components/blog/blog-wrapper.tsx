...
export default function BlogWrapper({ children }: BlogFilterWrapperProps) {
  ...
  return (
    ...
    >
      <div id="header" className="w-full flex flex-row justify-between items-end">
        <h1 className="text-4xl font-bold mb-2">Blog</h1>

        <div className="w-full h-44 flex flex-row justify-end items-center gap-2">
          <Tooltip>
            <TooltipTrigger>
              <Button variant="ghost" size="icon" className="rounded-full p-2 w-12 h-12">
                <svg
                  viewBox="0 0 512 512"
                  version="1.1"
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      {" "}
                      <g id="icon" fill="#09244B" transform="translate(42.666667, 33.830111)">
                        {" "}
                        <path
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <g id="页面-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  {" "}
                  <g id="Logo" transform="translate(-816.000000, -144.000000)" fill-rule="nonzero">
                    {" "}
                    <g id="vue_fill" transform="translate(816.000000, 144.000000)">
                      {" "}
                      <path
